...
namespace MbyronModsCommon.UI {
    ...
    public class CustomTabs<TypeContainer> where TypeContainer : UIComponent {
        ...
        public TypeContainer AddTab(string containerName, string text, float? posX, float? posY, float textScale = 1f, string tooltip = null, Action<TabButton> setSprite = null) {
            TabPanel.AddTab(text, textScale, tooltip, setSprite);
