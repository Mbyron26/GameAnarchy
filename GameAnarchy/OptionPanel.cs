...
namespace GameAnarchy {
    ...
    public class Option : OptionPanelBase<Mod, Config, Option> {
        //protected override float GeneralContainerWidth => (float)TypeWidth.ShrinkageWidth;
        ...
        //protected override void ResetSettings() => ResetSettings<Option>();
        ...
        //private void AddModInfoProperty() {
