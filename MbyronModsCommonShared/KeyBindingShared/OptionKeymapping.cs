/*Part of code is referenced to AlgernonCommons, thanks to algernon's open source code.*/
...
namespace MbyronModsCommon {
    public class OptionKeymapping : UICustomControl {
        ...
        public OptionKeymapping() {
            Panel = component.AttachUIComponent(UITemplateManager.GetAsGameObject("KeyBindingTemplate")) as UIPanel;
            Label = Panel.Find<UILabel>("Name");
            Button = Panel.Find<UIButton>("Binding");
        ...
        private void OnBindingMouseDown(UIComponent component, UIMouseEventParameter eventParam) {
            ...
            if (!IsInitialized) {
                ...
                Button.text = CommonLocale.KeyBinding_PressAnyKey;
                Button.Focus();
                IsInitialized = true;
